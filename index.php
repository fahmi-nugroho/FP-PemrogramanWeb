        ...
        <div class="col-md-10">
            ...
            ?>
                <div class="card mr-2 ml-2 mb-2" style="width: 16rem;">
                    <img src="assets/img/<?php echo $data['gambar'] ?>" class="card-img-top"
                        alt="<?php echo $data['jenis_voucher'] ?>">
                </div>
                <?php endwhile; ?>
            </div>
...
>>>>>>> deeb6f912aab6de114034ae3fc85698724799708
          ?>
                    <div class="modal fade" id="produk<?php echo $data['id_produk'] ?>" tabindex="-1"
                        aria-labelledby="produk<?php echo $data['id_produk'] ?>Label" aria-hidden="true">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="produk<?php echo $data['id_produk'] ?>Label">Detail
                                        Produk</h5>
                                ...
                                ?>
                                                ...
                                                <tr>
                                                    <th>Harga</th>
                                                    <<<<<<< HEAD <td>Rp. <?php echo number_format($data['harga']) ?>,00
                                                        </td>
                                                        =======
                                ...
                                <div class="modal-footer">
                                    ...
                                    <<<<<<< HEAD <?php if (isset($_SESSION['cart_'.$data['id_produk']])): ?>
                                        <?php if ($_SESSION['cart_'.$data['id_produk']] < $data['stok']): ?> <button
                                        type="button" id="AC-<?= $data['id_produk'] ?>" class="btn btn-success"
                                        data-dismiss="modal"
                                        onclick="addCarts(<?= $_SESSION['cart_'.$data['id_produk']] ?>, <?= $data['stok'] ?>, <?= $data['id_produk'] ?>)">
                                        + Keranjang</button>
                                        <?php else: ?>
